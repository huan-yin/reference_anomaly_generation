...
class StableDiffusionInpaintPipeline(
    ...
    def prepare_latents(
        ...
        return outputs, ref_image_latents
    ...
    def __call__(
        ...
        **kwargs,
        ...
        source_init_image = self.image_processor.preprocess(ref_image, height=height, width=width)
        ...
        latents_outputs, ref_image_latents = self.prepare_latents(
